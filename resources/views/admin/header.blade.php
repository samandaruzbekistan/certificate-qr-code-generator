    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="/admin/home">
                <span class="align-middle">RichBoss | Certificate</span>
            </a>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item @yield('home')">
                    <a class="sidebar-link" href="{{ route('admin.home') }}">
                        ...
                        <span class="align-middle">Serifikatlar</span>
                    </a>
                </li>
            ...
            <div class="container-fluid">
                <div class="row text-muted">
                    <div class="col-6 text-start">
                        <p class="mb-0">
                            <a class="text-muted" href="#" target="_blank"><strong>RichBoss</strong></a> - <a class="text-muted" href="#" target="_blank"><strong>Xususiy maktabi</strong></a>								&copy;
                        </p>
                    </div>
